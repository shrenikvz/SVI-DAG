...
| `SVIDAG_POSTERIOR_BIAS_INTERCEPT` | — | `-1.0` | `-2.0` | — | `0.0` | `-1.0` |
| `SVIDAG_POSTERIOR_BIAS_LOG10_SLOPE` | — | `2.0` | `4.0` | — | `4.0` | `0.0` |
| `SVIDAG_POSTERIOR_BIAS_REFERENCE_N` | — | `100` | `100` | — | `100` | `100` |
| `SVIDAG_POSTERIOR_BIAS_FLOOR` | — | `-4.5` | `-4.0` | — | `-8.0` | — |
| `SVIDAG_POSTERIOR_BIAS_CEILING` | — | `1.0` | `0.0` | — | `-1.0` | — |
| `SVIDAG_POSTERIOR_SCALE_INTERCEPT` | — | `2.0` | `3.0` | — | `3.0` | — |
...
| `SVIDAG_POSTERIOR_Z_SCALE_INTERCEPT` | — | `-1.0` | `0.0` | — | `0.0` | — |
